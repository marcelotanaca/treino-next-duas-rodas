  ...
  return (
    <div>
      ...
      <div className={styles.imgmoto2}>
        <Image width={150} height={130}  src={moto2} alt={"Imagem moto2"} />
        <ul>
          <p>
      ...
      <div className={styles.section}>
        <p className={styles.texto3}>Localização da Oficina</p>
        <p className={styles.texto4}>Nossa Oficina está localizada no centro da cidade</p>
        <iframe
          ...
          style={{ border: 0, width: 900, height: 300 }}
          allowFullScreen
          loading="lazy"
        ></iframe>
        <p className={styles.texto5}>Credenciada nas Marcas</p>
        <div className={styles.listacredenciada}>
          <ul>
            <p className={styles.tip}>HONDA</p>
            <p className={styles.tip1}>YAMAHA</p>
            <p className={styles.tip1}>SUZUKI</p>
            <p className={styles.tip1}>KAWASAKI</p>
            <p className={styles.tip1}>HARLEY-DAVIDSON</p>
          </ul>
          <div className={styles.imgoficina}>
            <Image  width={300} height={150} src={oficina} alt="Imagem Oficina" />
          </div>
        </div>
        <p className={styles.texto4}>Saiba um pouco mais sobre nossa oficina!</p>
        <iframe className={styles.video}
          src="https://www.youtube.com/embed/V31FzF7d8ac"
          title="YouTube video player"
          allow="accelerometer; autoplay; clipboard-write;
          encrypted-media; gyroscope; picture-in-picture"
          style={{ border: 0, width: 560, height: 315 }}
          frameBorder={0}
        ></iframe>
      </div>
    </div>
